...
try:
    ...
    from oak_ip_config import ensure_oak_poe_static_ip
...
# OAK Camera instance
# depthai is optional: on an Ubuntu/Windows desktop without an OAK camera
# the backend still boots so the UI and non-camera APIs work. Camera features
# guard on HAS_DEPTHAI and report a clear message instead of crashing.
try:
